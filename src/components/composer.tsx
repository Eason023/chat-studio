  ...
  return (
    <div className="mx-auto max-w-5xl rounded-xl border bg-card shadow-sm">
      <div className="flex min-h-[184px] flex-col p-3 sm:min-h-[216px]">
        ...
        <div className="h-[108px] shrink-0 sm:h-[132px]">
          <Textarea
            value={value}
            ...
            style={textareaStyle}
            className="h-full max-h-full min-h-0 resize-none overflow-y-auto border-0 bg-transparent px-0 py-1 shadow-none focus-visible:ring-0"
          />
        </div>
